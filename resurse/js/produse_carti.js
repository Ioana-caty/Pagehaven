    window.onload = function () {
        ...
        let iduriAscunse = JSON.parse(sessionStorage.getItem("produxzse_ascunse") || "[]");
        ...
        // validation in real time on input 
        document.getElementById("inp-descriere").oninput = function() {
            const regexValidare = /^[a-zA-Z0-9, \săâîșț]*$/;
        ...
        document.getElementById("inp-titlu").oninput = function() {
            const valTitlu = this.value.trim();
        ...
        function sorteaza(semn) {
            ...
            vProduse.sort(function (a, b) {
                ...
                let fixatA = a.classList.contains("produs-fixat");
                let fixatB = b.classList.contains("produs-fixat");
                if (fixatA && !fixatB) return -1; // a e fixat => a este primul
                if (!fixatA && fixatB) return 1;  // b e fixat => b este primul
